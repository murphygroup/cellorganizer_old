...
param.protein.class = 'vesicle';
param.protein.type = 'gmm';
...
param.downsampling = [1,1,1];

param.tempparent = [pwd filesep 'temp' filesep];

%documentation
param.documentation.description = 'This model has been trained using demo3D37 from CellOrganizer';
