...
classdef test_train_flag12 < matlab.unittest.TestCase
    properties
    end
    ...
    methods (Test)
        function test_basic_run( testCase )
            ...
            dna = [ directory filesep 'orgdna' filesep 'cell[0-9].tif' ];
            cellm = [ directory filesep 'orgcell' filesep 'cell[0-9].tif' ];
