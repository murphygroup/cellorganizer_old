...
classdef test_demo3D43 < matlab.unittest.TestCase
    properties
    end
    ...
    methods (Test)
        function test_basic_run( testCase )
            ...
            testCase.verifyEqual( exist( './img/cell1/standardized_voxels1.tif', 'file' ), 2 );
            ...
            if exist( './img/cell1/standardized_voxels1.tif', 'file' )
                delete( './img/cell1/standardized_voxels1.tif' );
            end           
