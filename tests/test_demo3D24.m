...
classdef test_demo3D24 < matlab.unittest.TestCase
    properties
    end
    methods (Test)
        function test_basic_run( testCase )
            directory = pwd;
            testCase.verifyTrue( demo3D24() );
            testCase.verifyEqual(exist('./Motivating_example_cBNGL2_13_sbml.xml','file'), 2);
            ...
            if exist('./Motivating_example_cBNGL2_13_sbml.xml','file')
                delete('./Motivating_example_cBNGL2_13_sbml.xml');
            end
