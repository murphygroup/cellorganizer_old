...
classdef test_demo3D34 < matlab.unittest.TestCase
    properties
    end
    ...
    methods (Test)
        function test_basic_run( testCase )
            ...
            testCase.verifyEqual( exist( './img/cell1/cell1.ome.tif', 'file' ), 2 );
            testCase.verifyEqual( exist( './img/cell1/cell.xml', 'file' ), 2 );
