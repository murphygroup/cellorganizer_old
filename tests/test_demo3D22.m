...
classdef test_demo3D22 < matlab.unittest.TestCase
    properties
    end
    ...
    methods (Test)
        function test_basic_run( testCase )
            ...
            testCase.verifyTrue( demo3D22() );
            testCase.verifyEqual( exist( './cell1', 'dir' ), 7 );
            testCase.verifyEqual( exist( './cell1/cell.tif', 'file'), 2 );
            testCase.verifyEqual( exist( './cell1/nucleus.tif', 'file'), 2 );
            testCase.verifyEqual( exist( './cell1/vesicle1.tif', 'file'), 2 );
