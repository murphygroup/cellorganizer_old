...
% Attempt to compile the binaries for all 4 major high-level functions.
try 
...
% add files to deployable archive because dependency analyzer will not find them during compilation
try
