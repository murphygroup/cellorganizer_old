function [ result ] = instance2SBML_LibSBML5_10( CSGdata, Meshdata, savepath, SBMLfile,resolution )
...
if(SBMLfile == 1)
    %There is no existing SBML model we are adding to, load the template
    SBMLfile = which('template.xml');
end

SBMLstruct = TranslateSBML(SBMLfile);
