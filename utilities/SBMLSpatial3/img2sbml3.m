function img2sbml3( imgpath, names, ordinalList, savepath, resolution, SBMLfile )
% IMG2SBML  This function takes in an image path and a name creates an SBML-spatial
% file for it. 
...
[ result ] = instance2SBML3( CSGboxes, sbmlStruct, savepath, SBMLfile,resolution)l
end 
