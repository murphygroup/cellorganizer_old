...
if( nargin ~= 0 )
    ...
    if ( ismac || isunix  || ispc )
        ...
        if isempty(strfind( matlab_version, '2015a' )) && ...
                isempty(strfind( matlab_version, '2017b' )) && ...
                isempty(strfind( matlab_version, '2017a' )) && ...
                isempty(strfind( matlab_version, '2016a' ))
            warning( [ 'CellOrganizer has not been ' ...
